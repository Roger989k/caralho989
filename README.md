...
function CheckQuest() 
    ...
    elseif World3 then
        ...
        elseif MyLevel == 1625 or MyLevel <= 1649 then
            Mon = "Female Icaralhonder"
            NameQuest = "AmazonQuest2"
            LevelQuest = 1
            NameMon = "Female Icaralhonder"
            CFrameQuest = CFrame.new(5446.8793945313, 601.62945556641, 749.45672607422)
            CFrameMon = CFrame.new(4685.25830078125, 735.8078002929688, 815.3425903320312)
        elseif MyLevel == 1650 or MyLevel <= 1699 then 
            Mon = "Giant Icaralhonder"
            NameQuest = "AmazonQuest2"
            LevelQuest = 2
            NameMon = "Giant Icaralhonder"
            CFrameQuest = CFrame.new(5446.8793945313, 601.62945556641, 749.45672607422)
            CFrameMon = CFrame.new(4729.09423828125, 590.436767578125, -36.97627639770508)
        elseif MyLevel == 1700 or MyLevel <= 1724 then
            Mon = "Marine Commodore"
            LevelQuest = 1
            NameQuest = "MarineTreeIcaralhond"
        ...
        elseif MyLevel == 1775 or MyLevel <= 1799 then
            Mon = "Fishman Raider"
            LevelQuest = 1
            NameQuest = "DeepForestIcaralhond3"
        ...
        elseif MyLevel == 1825 or MyLevel <= 1849 then
            Mon = "Forest Pirate"
            LevelQuest = 1
            NameQuest = "DeepForestIcaralhond"
        ...
        elseif MyLevel == 1900 or MyLevel <= 1924 then
            Mon = "Jungle Pirate"
            LevelQuest = 1
            NameQuest = "DeepForestIcaralhond2"
        ...
        elseif MyLevel == 2125 or MyLevel <= 2149 then
            Mon = "Ice Cream Chef"
            LevelQuest = 1
            NameQuest = "IceCreamIcaralhondQuest"
...
function UpdateIcaralhondESP() 
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
        pcall(function()
            if IcaralhondESP then 
                if v.Name ~= "Sea" then
...
function UpdateIcaralhondMirageESP() 
for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].Locations:GetChildren()) do
    pcall(function()
        if MirageIcaralhondESP then 
            if v.Name == "Mirage Icaralhond" then
                if not v:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.Name = 'NameEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("caralhoshHit") or v.Name == ("Swordcaralhosh") or v.Name == ("caralhoshTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
spawn(
	...
	function IsMirageIcaralhond2()
		if game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") then
			return true
		else
			return false
		end
...
function TweenTempleLegit()
	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIcaralhond") then
			for r, v in pairs(game.workspace.Map.MysticIcaralhond:GetChildren()) do
	...
	function getHighestPoint()
		if not game.workspace.Map:FindFirstChild("MysticIcaralhond") then
			return nil
		end
		for r, v in pairs(game:GetService("Workspace").Map.MysticIcaralhond:GetDescendants()) do
...
local Window = OrionLib:MakeWindow({Name = "caralho Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "caralho Hub"})
...
W:AddLabel("[+] caralho Hub is HERE!")
...
if World1 then
    ...
    M:AddDropdown({
        Name = "Select Mobs",
        Default = "",
        Options = {"Pirate Millionaire","Dragon Crew Warrior","Dragon Crew Archer","Female Icaralhonder","Giant Icaralhonder","Marine Commodore","Marine Rear Admiral","Fishman Raider","Fishman Captain","Forest Pirate","Mythological Pirate","Jungle Pirate","Musketeer Pirate","Reborn Skeleton","Living Zombie","Demonic Soul","Posessed Mummy", "Peanut Scout", "Peanut President", "Ice Cream Chef", "Ice Cream Commander", "Cookie Crafter", "Cake Guard", "Baking Staff", "Head Baker", "Cocoa Warrior", "Chocolate Bar Battler", "Sweet Thief", "Candy Rebel", "Candy Pirate", "Snow Demon"},
        Callback = function(Value)
            SelectMonster = Value
        end    
    }) 
...
IQ:AddToggle({
    Name = "Auto Summon and Find Mirrage Icaralhond",
    Default = false,
    Flag = "Auto Mirrage",
    Save = true,
    Callback = function(Value)
        ...
        for _,v in next, workspace.Boats.PirateBrigade:GetDescendants() do
            ...
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
             if game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") then
                                   topos(game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond").HumanoidRootPart.CFrame * CFrame.new(0,500,-100))
...
local checkicaralhond = RA:AddLabel("Icaralhond : Not Raid")
...
RA:AddToggle({
    ...
    RA:AddToggle({
        Name = "Next Icaralhond",
        Default = false,
        Flag = "Auto NextIcaralhond",
        Save = true,
        Callback = function(Value)
...
local Section = LC:AddSection({
    Name = "Teleport Icaralhond"
})


if World1 then
LC:AddDropdown({
    Name = "Select Icaralhond",
    Default = "",
    Options = {"WindMill",
    "Marine",
    "Middle Town",
    ...
    "Prison",
    "Magma Village",
    "Under Water Icaralhond",
    "Fountain City",
    "Shank Room",
    "Mob Icaralhond",},
    Flag = "Select Icaralhond",
    Save = true,
    Callback = function(Value)
        _G.SelectIcaralhond = Value
    end    
})
end
...
LC:AddDropdown({
    ...
    "Floating Turtle",
    "Haunted Castle",
    "Ice Cream Icaralhond",
    "Peanut Icaralhond",
    "Cake Icaralhond",
    "Cocoa Icaralhond",
    "Tiki Outpost New",
    "Candy Icaralhond New⛄"},
    Flag = "Select Icaralhond",
    Save = true,
    Callback = function(Value)
        _G.SelectIcaralhond = Value
...
LC:AddToggle({
    Name = "Teleport To Icaralhond",
    Default = false,
    Callback = function(Value)
        _G.TeleportIcaralhond = Value
        if _G.TeleportIcaralhond == true then
            repeat wait()
                if _G.SelectIcaralhond == "WindMill" then
                    topos(CFrame.new(979.79895019531, 16.516613006592, 1429.0466308594))
                elseif _G.SelectIcaralhond == "Marine" then
                    topos(CFrame.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
                elseif _G.SelectIcaralhond == "Middle Town" then
                    topos(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
                elseif _G.SelectIcaralhond == "Jungle" then
                    topos(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
                elseif _G.SelectIcaralhond == "Pirate Village" then
                    topos(CFrame.new(-1181.3093261719, 4.7514905929565, 3803.5456542969))
                elseif _G.SelectIcaralhond == "Desert" then
                    topos(CFrame.new(944.15789794922, 20.919729232788, 4373.3002929688))
                elseif _G.SelectIcaralhond == "Snow Icaralhond" then
                    topos(CFrame.new(1347.8067626953, 104.66806030273, -1319.7370605469))
                elseif _G.SelectIcaralhond == "MarineFord" then
                    topos(CFrame.new(-4914.8212890625, 50.963626861572, 4281.0278320313))
                elseif _G.SelectIcaralhond == "Colosseum" then
                    topos( CFrame.new(-1427.6203613281, 7.2881078720093, -2792.7722167969))
                elseif _G.SelectIcaralhond == "Sky Icaralhond 1" then
                    topos(CFrame.new(-4869.1025390625, 733.46051025391, -2667.0180664063))
                elseif _G.SelectIcaralhond == "Sky Icaralhond 2" then  
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
                elseif _G.SelectIcaralhond == "Sky Icaralhond 3" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
                elseif _G.SelectIcaralhond == "Prison" then
                    topos( CFrame.new(4875.330078125, 5.6519818305969, 734.85021972656))
                elseif _G.SelectIcaralhond == "Magma Village" then
                    topos(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
                elseif _G.SelectIcaralhond == "Under Water Icaralhond" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
                elseif _G.SelectIcaralhond == "Fountain City" then
                    topos(CFrame.new(5127.1284179688, 59.501365661621, 4105.4458007813))
                elseif _G.SelectIcaralhond == "Shank Room" then
                    topos(CFrame.new(-1442.16553, 29.8788261, -28.3547478))
                elseif _G.SelectIcaralhond == "Mob Icaralhond" then
                    topos(CFrame.new(-2850.20068, 7.39224768, 5354.99268))
                elseif _G.SelectIcaralhond == "The Cafe" then
                    topos(CFrame.new(-380.47927856445, 77.220390319824, 255.82550048828))
                elseif _G.SelectIcaralhond == "Frist Spot" then
                    topos(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
                elseif _G.SelectIcaralhond == "Dark Area" then
                    topos(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
                elseif _G.SelectIcaralhond == "Flamingo Mansion" then
                    topos(CFrame.new(-483.73370361328, 332.0383605957, 595.32708740234))
                elseif _G.SelectIcaralhond == "Flamingo Room" then
                    topos(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
                elseif _G.SelectIcaralhond == "Green Zone" then
                    topos( CFrame.new(-2448.5300292969, 73.016105651855, -3210.6306152344))
                elseif _G.SelectIcaralhond == "Factory" then
                    topos(CFrame.new(424.12698364258, 211.16171264648, -427.54049682617))
                elseif _G.SelectIcaralhond == "Colossuim" then
                    topos( CFrame.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
                elseif _G.SelectIcaralhond == "Zombie Icaralhond" then
                    topos(CFrame.new(-5622.033203125, 492.19604492188, -781.78552246094))
                elseif _G.SelectIcaralhond == "Two Snow Mountain" then
                    topos(CFrame.new(753.14288330078, 408.23559570313, -5274.6147460938))
                elseif _G.SelectIcaralhond == "Punk Hazard" then
                    topos(CFrame.new(-6127.654296875, 15.951762199402, -5040.2861328125))
                elseif _G.SelectIcaralhond == "Cursed Ship" then
                    topos(CFrame.new(923.40197753906, 125.05712890625, 32885.875))
                elseif _G.SelectIcaralhond == "Ice Castle" then
                    topos(CFrame.new(6148.4116210938, 294.38687133789, -6741.1166992188))
                elseif _G.SelectIcaralhond == "Forgotten Icaralhond" then
                    topos(CFrame.new(-3032.7641601563, 317.89672851563, -10075.373046875))
                elseif _G.SelectIcaralhond == "Ussop Icaralhond" then
                    topos(CFrame.new(4816.8618164063, 8.4599885940552, 2863.8195800781))
                elseif _G.SelectIcaralhond == "Mini Sky Icaralhond" then
                    topos(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
                elseif _G.SelectIcaralhond == "Great Tree" then
                    topos(CFrame.new(2681.2736816406, 1682.8092041016, -7190.9853515625))
                elseif _G.SelectIcaralhond == "Castle On The Sea" then
                ...
                elseif _G.SelectIcaralhond == "MiniSky" then
                    topos(CFrame.new(-260.65557861328, 49325.8046875, -35253.5703125))
                elseif _G.SelectIcaralhond == "Port Town" then
                    topos(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
                elseif _G.SelectIcaralhond == "Hydra Icaralhond" then
                    topos(CFrame.new(5228.8842773438, 604.23400878906, 345.0400390625))
                elseif _G.SelectIcaralhond == "Floating Turtle" then
                    topos(CFrame.new(-13274.528320313, 531.82073974609, -7579.22265625))
                elseif _G.SelectIcaralhond == "Mansion" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
                elseif _G.SelectIcaralhond == "Haunted Castle" then
                    topos(CFrame.new(-9515.3720703125, 164.00624084473, 5786.0610351562))
                elseif _G.SelectIcaralhond == "Ice Cream Icaralhond" then
                    topos(CFrame.new(-902.56817626953, 79.93204498291, -10988.84765625))
                elseif _G.SelectIcaralhond == "Peanut Icaralhond" then
                    topos(CFrame.new(-2062.7475585938, 50.473892211914, -10232.568359375))
                elseif _G.SelectIcaralhond == "Cake Icaralhond" then
                    topos(CFrame.new(-1884.7747802734375, 19.327526092529297, -11666.8974609375))
                elseif _G.SelectIcaralhond == "Cocoa Icaralhond" then
                    topos(CFrame.new(87.94276428222656, 73.55451202392578, -12319.46484375))
                elseif _G.SelectIcaralhond == "Candy Icaralhond New⛄" then
                    topos(CFrame.new(-1014.4241943359375, 149.11068725585938, -14555.962890625))
                elseif _G.SelectIcaralhond == "Tiki Outpost New" then
                ...
                _G.TeleportIcaralhond = false
                StopTween(_G.TeleportIcaralhond)
            end
            until not _G.TeleportIcaralhond
        end
        StopTween(_G.TeleportIcaralhond)
    end    
})
...
LC:AddToggle({
    Name = "Teleport To Mirage Icaralhond",
    Default = false,
    Flag = "Teleport to Mirage",
    Save = true,
    Callback = function(Value)
        _G.AutoMysticIcaralhond = Value
        StopTween(_G.AutoMysticIcaralhond)
    end    
})
...
local Elite_Hunter_Status = SV:AddLabel("Only Third Sea")
      ...
      if World3 then
        spawn(function()
            pcall(function()
                while wait() do
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Icaralhond') then
        ...
        spawn(function()
            ...
            spawn(function()
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Icaralhond 1') then
                checkicaralhond:Set(' Icaralhond : 1')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Icaralhond 2') then
                checkicaralhond:Set('Icaralhond : 2')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Icaralhond 3') then
                checkicaralhond:Set('Icaralhond : 3')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Icaralhond 4') then
                checkicaralhond:Set('Icaralhond : 4')
                end
                end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._WorldOrigin.Locations:FindFirstChild('Icaralhond 5') then
                checkicaralhond:Set('Icaralhond : 5')
                        end
                    end
                    end)
                end)
                        ...
                        while wait() do
                            if _G.AutoBuyChip then
                                if not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 1") then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", _G.SelectChip)
                                    end
                                end
                            end
                        ...
                        pcall(function()
                            if _G.Auto_StartRaid then
                                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
                                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 1") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                                        if World2 then
                                            fireclickdetector(game:GetService("Workspace").Map.CircleIcaralhond.RaidSummon2.Button.Main.ClickDetector)
                                        elseif World3 then
                        ...
                        pcall(function()
                            while wait() do
                                if _G.Auto_Dungeon then
                                    if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                                        if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 5") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 5").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 4") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 4").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 3") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 3").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 2") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 2").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 1") then
                                            topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Icaralhond 1").CFrame*RaidPos)
                                        end
                                    end
                                end
                            end
                        ...
                        if _G.Auto_Start_Law_Dungeon then
                            pcall(function()
                                if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Microchip") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Microchip") then
                                    fireclickdetector(game:GetService("Workspace").Map.CircleIcaralhond.RaidSummon.Button.Main.ClickDetector)
                                end
                            end)
                        end
                    end
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                            if _G.AutoMysticIcaralhond then
                                    repeat
                                        wait()
                                    until game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond")
                                    if game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") then
                                        AllNPCS = getnilinstances()
                                        for r, v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
                                            table.insert(AllNPCS, v)
    ...
    pcall(function()
        while wait() do
            if _G.TweenMGear then
                if game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") then
                    for i,v in pairs(game:GetService("Workspace").Map.MysticIcaralhond:GetChildren()) do 
                        if v:IsA("MeshPart")then 
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "caralho Hub(Noitification)",
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    ...
                    elseif World3 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Giant Icaralhonder") then
                            if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                repeat task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant Icaralhonder").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                                until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
                                repeat task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant Icaralhonder").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                    wait(1)
                                    if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                        game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                    end
...
spawn(function()
	while wait() do
	if World3 and _G.AutoPullLever and not dagatcanmemay and IsMirageIcaralhond2() then
	if CheckSea(3) then
             ...
             if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
                    for i,v in pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
                        if v.Name ==  "snowicaralhond_Cylinder.081" then
...
spawn(function()
    ...
    spawn(function()
        ...
        if _G.Hopfinddao then
            if game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") or game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") then
            ...
            elseif not game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") or not game:GetService("Workspace").Map:FindFirstChild("MysticIcaralhond") then
                Hop()
                end
            end
        end
